      ...
      <div className="card basic-details-card">
        ...
        <div className="card-body">
          ...
          <div className="form-group">
            ...
            <input
              id="createAtivityType"
              name="createAtivityType"
              type="text"
              onChange={handleChange}
              onBlur={handleBlur}
              value={values.createAtivityType}
              className="form-control"
            />
            {touched.createAtivityType && errors.createAtivityType && (
              <div className="error">{errors.createAtivityType}</div>
            )}
          </div>
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleChange}
              onBlur={handleBlur}
              value={values.activityImage}
              className="form-control"
            />
            {touched.activityImage && errors.activityImage && (
              <div className="error">{errors.activityImage}</div>
            )}
          </div>
          <div className="form-group">
