      ...
      <div className="card participants-validation-card">
        ...
        <div className="card-body">
          ...
          {values.ageRestriction && (
            <div className="form-group">
              ...
              <input
                ...
                onChange={handleChange}
                onBlur={handleBlur}
                value={Array.isArray(values.ages) ? values.ages.join(', ') : ''}
          ...
          <div className="form-group">
            ...
            <input
              id="attendeesValidation"
              name="attendeesValidation"
              type="checkbox"
              onChange={handleChange}
              onBlur={handleBlur}
              checked={values.attendeesValidation}
              className="form-check-input"
            />
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {touched.attendeeLimit && errors.attendeeLimit && (
              <div className="text-danger">{errors.attendeeLimit}</div>
            )}
          </div>
          <div className="form-group">
