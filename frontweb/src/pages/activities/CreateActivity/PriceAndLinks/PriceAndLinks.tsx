        ...
        <div className="card-body">
          ...
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {touched.ticketLink && errors.ticketLink && (
              <div className="text-danger">{errors.ticketLink}</div>
            )}
          </div>
          <div className="form-group">
            ...
            <input
              ...
              onChange={handleChange}
              onBlur={handleBlur}
              value={values.infoLine ?? ''}
              className="form-control"
            />
            {touched.infoLine && errors.infoLine && (
              <div className="text-danger">{errors.infoLine}</div>
            )}
          </div>
          <div className="form-group">
            ...
            <input
              ...
              className="form-control"
            />
            {touched.howToFind && errors.howToFind && (
              <div className="text-danger">{errors.howToFind}</div>
            )}
          </div>
        </div>
      </div>
