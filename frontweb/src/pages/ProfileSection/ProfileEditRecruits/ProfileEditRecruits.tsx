...
import { getCompanyById, updateCompany } from '../../../redux/features/company/companySlice';
...
const ProfileEditRecruits: React.FC = () => {
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values, { setSubmitting }) => {
      try {
        const updatedValues = {
          ...values,
          foundedDate: values.foundedDate ? new Date(values.foundedDate) : undefined,
  ...
  return (
    <div className="profile-edit-recruits-container">
      ...
      <form onSubmit={formik.handleSubmit} className="profile-edit-recruits-form">
        <div className="form-group">
          ...
          <input
            ...
            className={formik.touched.companyName && formik.errors.companyName ? 'error-input' : ''}
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={
              formik.touched.companyRegistrationNumber && formik.errors.companyRegistrationNumber
                ? 'error-input'
                : ''
            }
          />
          {formik.touched.companyRegistrationNumber && formik.errors.companyRegistrationNumber ? (
            <div className="error">{formik.errors.companyRegistrationNumber}</div>
          ) : null}
        </div>
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={formik.touched.street && formik.errors.street ? 'error-input' : ''}
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={formik.touched.state && formik.errors.state ? 'error-input' : ''}
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={formik.touched.zipCode && formik.errors.zipCode ? 'error-input' : ''}
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={
              formik.touched.industryType && formik.errors.industryType ? 'error-input' : ''
            }
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={
              formik.touched.contactEmail && formik.errors.contactEmail ? 'error-input' : ''
            }
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={
              formik.touched.contactPhone && formik.errors.contactPhone ? 'error-input' : ''
            }
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={formik.touched.website && formik.errors.website ? 'error-input' : ''}
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={formik.touched.foundedDate && formik.errors.foundedDate ? 'error-input' : ''}
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={formik.touched.logo && formik.errors.logo ? 'error-input' : ''}
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={formik.touched.linkedin && formik.errors.linkedin ? 'error-input' : ''}
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={formik.touched.facebook && formik.errors.facebook ? 'error-input' : ''}
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={formik.touched.twitter && formik.errors.twitter ? 'error-input' : ''}
          />
        ...
        <div className="form-group">
          ...
          <input
            ...
            className={formik.touched.instagram && formik.errors.instagram ? 'error-input' : ''}
          />
        ...
        <div className="form-group">
          ...
          <select
            ...
            className={formik.touched.companySize && formik.errors.companySize ? 'error-input' : ''}
          >
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            className={
              formik.touched.subsidiaries && formik.errors.subsidiaries ? 'error-input' : ''
            }
          />
        ...
        <div className="form-group">
          ...
          <textarea
            ...
            className={
              formik.touched.certifications && formik.errors.certifications ? 'error-input' : ''
            }
          />
