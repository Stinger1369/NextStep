...
export const userFriendlyMessages = {
  ...
  [ERROR_CODES.ErrDecodingBase64]:
    "There was an error decoding the image. Please try again.",
  [ERROR_CODES.ErrWritingFile]:
    "There was an error saving the image. Please try again.",
  [ERROR_CODES.ErrMaxImagesReached]:
