...
export const config = {
  mongoURI: process.env.MONGO_URI_Backend_NODE || "mongodb://localhost:27017/recruteProject",
  ...
  imageServerURL: process.env.IMAGE_SERVER_URL || 'http://57.129.35.0:7000/server-image',
